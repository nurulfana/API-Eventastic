...
<body>
  ...
  <script>
    function myFunction() {
      alert('Demo Accounts : \n\nADMIN \nEmail Address: luqman@gmail.com \nPassword:123 ')
    }
  </script>
  ...
  <div class="container jumbotron">
    <br><br>
    <img src="Random.png" width="45%" height='auto'>
    <br><br>
    <hr>
    <h2>admin login</h2>
    <form action="login1.php" method="post" class="form-horizontal">
    <div class="form-group">
        <input name="adminemail" type="text" placeholder="Email Address" required>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <button type="button" name="register" title='Register Venue' onclick="window.location='venueform.php';" class="btn btn-info full-width"><span class="glyphicon glyphicon-plus"></span></button>
      </div>
